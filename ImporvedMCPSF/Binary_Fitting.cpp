...
int main() 
{
	...
	cout << endl;
    	...
    	//find the 3 best fits by residual error
    	xt::xarray<int> top_three = xt::view(xt::argpartition(residual_error_array, 3),xt::range(0,3));
    	xt::dump_npy("top_three.npy", top_three);
